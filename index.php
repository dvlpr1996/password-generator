...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-8 col-lg-6 mx-auto">
            <input type="text" class="form-control" id="copy" data-action="pass" value="<?= $pass ?? 'your generated password' ?>" readonly>
        </div>
    </div>
    ...
    <form action="<?= action('password') ?>" method="POST" class="row justify-content-evenly align-items-center mt-3">
        ...
        <div class="text-center mt-4">
            <button type="button" class="btn btn-copy m-3" data-clipboard-action="copy" data-clipboard-target="#copy">copy to
                clipboard</button>
            <button type="submit" class="btn" name="generate" value="generate Password">
                generate Password
            </button>
        </div>
